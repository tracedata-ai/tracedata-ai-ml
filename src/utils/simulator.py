...
def simulate_data(num_drivers=5, trips_per_driver=10):
    ...
    for i in range(num_drivers):
        ...
        for t in range(trips_per_driver):
            ...
            if i == 0:
                style = "smooth"  # Ahmad is a pro
            elif i == 1:
                style = "jerky"  # Siti is learning
            else:
                style = random.choice(["smooth", "jerky", "unsafe"])
    ...
    conn.close()
    print(
        f"✅ Simulated data for {num_drivers} drivers and {num_drivers * trips_per_driver} trips."
    )
